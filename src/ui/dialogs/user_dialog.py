...
class NewUserDialog(QDialog):
    ...
    def connect_signals(self):
        ...
        # Conectar Enter en todos los campos de texto para crear usuario
        self.nombre_edit.returnPressed.connect(self.create_user)
        self.nombre_social_edit.returnPressed.connect(self.create_user)
        self.rut_edit.returnPressed.connect(self.create_user)
        self.medico_edit.returnPressed.connect(self.create_user)
        self.diagnostico_edit.returnPressed.connect(self.create_user)
        self.institucion_edit.returnPressed.connect(self.create_user)
        self.numero_estudio_edit.returnPressed.connect(self.create_user)
        self.telefono_edit.returnPressed.connect(self.create_user)
        self.email_edit.returnPressed.connect(self.create_user)
