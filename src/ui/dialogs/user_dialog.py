...
class NewUserDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.telefono_edit.setPlaceholderText("+56 9 1234 5678")
        contact_layout.addRow("Teléfono:", self.telefono_edit)
        
        # Email
        self.email_edit = QLineEdit()
        self.email_edit.setPlaceholderText("paciente@email.com")
