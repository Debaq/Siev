...
from utils.V4L2Camera import V4L2Camera
...
class VideoManagerAPI:
    ...
    def __init__(self):
        ...
        print("VideoManagerAPI initialized")
    ...
    def initialize(
        ...
        try:
            ...
            print(f"VideoManagerAPI initialized: {width}x{height}@{fps}fps")
            return True
    ...
    def start_capture(self) -> bool:
        ...
        if not self.is_initialized:
            print("Error: Video manager not initialized")
            return False
    ...
    def _process_eye_positions(self, pupil_positions: List, timestamp: float):
        """Process and store eye position data"""
    ...
    def start_recording(self) -> bool:
        ...
        if not self.is_capturing:
            print("Error: Cannot record without capture")
            return False
    ...
    def update_config(
        ...
        """Update video configuration dynamically"""
        if self.video_processes:
    ...
    def cleanup(self):
        """Clean up resources"""
        print("Cleaning up VideoManagerAPI...")
        ...
        self.is_initialized = False
        print("VideoManagerAPI cleaned up")
