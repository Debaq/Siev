...
class HardwareManagerAPI:
    ...
    def __init__(self):
        ...
        print("HardwareManagerAPI initialized")
    ...
    def initialize(self, port: str = None, baudrate: int = None) -> bool:
        ...
        try:
            ...
            if success:
                ...
                print("Error initializing serial communication")
                return False
    ...
    def _init_serial_communication(self, port: str, baudrate: int) -> bool:
        ...
        try:
            ...
            print(f"Serial communication established: {port}@{baudrate}")
            return True
    ...
    def _handle_serial_data(self, raw_data: str):
        """Process serial data received from IMU"""
        try:
    ...
    def _complete_calibration(self):
        ...
        print(f"Calibration completed: {self._calibration_data}")
    ...
    def cleanup(self):
        ...
        try:
            ...
            if self.serial_handler and hasattr(self.serial_handler, 'serial_port'):
                if hasattr(self.serial_handler.serial_port, 'close'):
            ...
            print("HardwareManagerAPI cleaned up")
